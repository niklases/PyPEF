...
def plot_performance(mut_data, plot_name, mut_sep=':'):
    ...
    mean_perf_texts.append(plt.text(len(tested_dsets) - 1, np.nanmean(dset_dca_perfs), f'{np.nanmean(dset_dca_perfs):.2f}'))
    ...
    mean_perf_texts.append(plt.text(len(tested_dsets) - 1, np.nanmean(np.array(dset_hybrid_perfs)[:, 0]), f'{np.nanmean(np.array(dset_hybrid_perfs)[:, 0]):.2f}'))
    ...
    mean_perf_texts.append(plt.text(len(tested_dsets) - 1, np.nanmean(np.array(dset_hybrid_perfs)[:, 1]), f'{np.nanmean(np.array(dset_hybrid_perfs)[:, 1]):.2f}'))
    ...
    mean_perf_texts.append(plt.text(len(tested_dsets) - 1, np.nanmean(np.array(dset_hybrid_perfs)[:, 2]), f'{np.nanmean(np.array(dset_hybrid_perfs)[:, 2]):.2f}'))
    ...
    mean_perf_texts.append(plt.text(len(tested_dsets) - 1, np.nanmean(np.array(dset_hybrid_perfs)[:, 3]), f'{np.nanmean(np.array(dset_hybrid_perfs)[:, 3]):.2f}'))
    ...
    mean_perf_texts.append(plt.text(len(tested_dsets) - 1, np.nanmean(np.array(dset_hybrid_perfs)[:, 4]), f'{np.nanmean(np.array(dset_hybrid_perfs)[:, 4]):.2f}'))
